  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          <td width="15%">CSS</td>
          <td width="100%"><img src="https://geps.dev/progress/72?color=1572B6&danger=true" alt="72%"></td>
          <td width="20%">72.0%</td>
        </tr>
        <tr>
          <td width="15%">C++</td>
          <td width="100%"><img src="https://geps.dev/progress/5?color=00599C&danger=true" alt="5%"></td>
          <td width="20%">5.0%</td>
        </tr>
        <tr>
          <td width="15%">Dart</td>
